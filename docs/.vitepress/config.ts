...
export default defineConfig({
  ...
  base: "/ai-articles/",
  description:
    "A comprehensive collection of React, TypeScript, and Next.js guides and tutorials.",
  ...
  themeConfig: {
    ...
    // Edit link
    editLink: {
      pattern: "https://github.com/langisor/ai-articles/edit/main/docs/:path",
        ...
        items: [
          {
            ...
            items: [
              {
                text: "Zustand Guide",
                link: "/react-ts/state-management/zustand",
              },
              {
                text: "Hookstate Guide",
                link: "/react-ts/state-management/hookstate",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              {
                text: "TS Cheatsheet",
                link: "/react-ts/master-ts-in-react/ts-cheatsheet",
              },
              {
                text: "Booklet Guide",
                link: "/react-ts/master-ts-in-react/booklet-guide",
              },
              {
                text: "Reference Guide",
                link: "/react-ts/master-ts-in-react/reference-guide",
              },
            ],
          },
          ...
          { text: "useReducer with TS", link: "/react-ts/useReducer-ts" },
          {
            ...
            link: "/react-ts/useMemo-useCallback",
          },
...

      {
        ...
        items: [
          ...
          },
          {
            ...
            link: "/nextjs/shopping-cart-example",
          },
...

      {
        ...
        items: [
          ...
          { text: "TanStack Query", link: "/tanstack-query-next14-app" },
          {
            ...
            items: [
              {
                text: "This Site How To",
                link: "/vitepress/ai-articles-site-example.md",
              },
              {
      ...
      "/react-ts/": [
        {
          ...
          items: [
            { text: "Mastering Hooks", link: "/react-ts/mastering-hooks" },
            {
              text: "useReducer with TypeScript",
              link: "/react-ts/useReducer-ts",
            },
            {
              text: "useMemo & useCallback",
              link: "/react-ts/useMemo-useCallback",
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Introduction", link: "/react-ts/react-context/intro" },
            {
              text: "Example 1: Basic Context",
              link: "/react-ts/react-context/ex1",
            },
            {
              text: "Example 2: Context with Reducer",
              link: "/react-ts/react-context/ex2",
            },
            {
              text: "Example 3: Advanced Patterns",
              link: "/react-ts/react-context/ex3",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: "/nextjs/action-swr-example",
            },
            {
              text: "Smart Table Component",
              link: "/nextjs/smart-table-component",
      ...
      "/": [
        {
          ...
          items: [{ text: "Introduction", link: "/example" }],
        },
        {
          text: "Popular Topics",
          items: [
            ...
            {
              text: "TanStack Query with Next.js 14",
              link: "/tanstack-query-next14-app",
            },
          ],
        },
        {
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/langisor/" }],
...
Add to nav array in config.ts
Add to corresponding sidebar section
 */
